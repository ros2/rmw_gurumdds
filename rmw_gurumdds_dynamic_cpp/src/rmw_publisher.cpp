  ...
  const char * topic_name, const rmw_qos_profile_t * qos_policies)
{
  ...
  if (node->implementation_identifier != gurum_gurumdds_dynamic_identifier) {
  ...
  publisher_info->implementation_identifier = gurum_gurumdds_dynamic_identifier;
  ...
  publisher_info->publisher_gid.implementation_identifier = gurum_gurumdds_dynamic_identifier;

  static_assert(
    sizeof(GurumddsPublisherGID) <= RMW_GID_STORAGE_SIZE,
    "RMW_GID_STORAGE_SIZE insufficient to store the rmw_gurumdds_dynamic_cpp GID implementation.");
  ...
  rmw_publisher->implementation_identifier = gurum_gurumdds_dynamic_identifier;
...
rmw_destroy_publisher(rmw_node_t * node, rmw_publisher_t * publisher)
{
  ...
  RMW_CHECK_TYPE_IDENTIFIERS_MATCH(
    node handle,
    node->implementation_identifier, gurum_gurumdds_dynamic_identifier,
    return RMW_RET_ERROR)
  ...
  RMW_CHECK_TYPE_IDENTIFIERS_MATCH(
    publisher handle,
    publisher->implementation_identifier, gurum_gurumdds_dynamic_identifier,
    return RMW_RET_ERROR)
  ...
  rmw_publisher_allocation_t * allocation)
{
  ...
  RCUTILS_LOG_DEBUG_NAMED("rmw_gurumdds_dynamic_cpp", "Published data on topic %s", topic_name);
