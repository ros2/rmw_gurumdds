  ...
  const rmw_qos_profile_t * qos_policies)
{
  ...
  RMW_CHECK_TYPE_IDENTIFIERS_MATCH(
    ...
    gurum_gurumdds_dynamic_identifier, return nullptr)
  ...
  client_info->implementation_identifier = gurum_gurumdds_dynamic_identifier;
  ...
  rmw_client->implementation_identifier = gurum_gurumdds_dynamic_identifier;
