...
get_publisher(rmw_publisher_t * publisher)
{
  ...
  if (publisher->implementation_identifier != gurum_gurumdds_dynamic_identifier) {
    return nullptr;
  }
...
get_subscriber(rmw_subscription_t * subscription)
{
  ...
  if (subscription->implementation_identifier != gurum_gurumdds_dynamic_identifier) {
    return nullptr;
  }
...
get_request_data_writer(rmw_client_t * client)
{
  ...
  if (client->implementation_identifier != gurum_gurumdds_dynamic_identifier) {
    return nullptr;
  }
...
get_request_data_reader(rmw_service_t * service)
{
  ...
  if (service->implementation_identifier != gurum_gurumdds_dynamic_identifier) {
    return nullptr;
  }
