  ...
  bool * taken)
{
  ...
  return _take(gurum_gurumdds_identifier, subscription, ros_message, taken, nullptr);
}
  ...
  rmw_message_info_t * message_info)
{
  ...
  return _take(
    gurum_gurumdds_identifier, subscription, ros_message, taken, message_info);
}
  ...
  bool * taken)
{
  ...
  return _take_serialized(
    gurum_gurumdds_identifier, subscription, serialized_message, taken, nullptr);
}
  ...
  rmw_message_info_t * message_info)
{
  ...
  return _take_serialized(
    gurum_gurumdds_identifier, subscription, serialized_message, taken, message_info);
}
}  // extern "C"
