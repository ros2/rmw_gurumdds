...
size_t service_request_serialize_direct(void* context, void* data, void* buffer, size_t buffer_size) {
  bool ret = false;
  auto rosidl_typesupport =
      reinterpret_cast<rosidl_service_type_support_t *>(context);
...
bool service_request_deserialize_direct(void* context, void* buffer, size_t buffer_size, void* data) {
  bool ret = false;
  auto rosidl_typesupport =
      reinterpret_cast<rosidl_service_type_support_t *>(context);
...
size_t service_response_serialize_direct(void* context, void* data, void* buffer, size_t buffer_size) {
  bool ret = false;
  auto rosidl_typesupport =
      reinterpret_cast<rosidl_service_type_support_t *>(context);
...
bool service_response_deserialize_direct(void* context, void* buffer, size_t buffer_size, void* data) {
  bool ret = false;
  auto rosidl_typesupport =
      reinterpret_cast<rosidl_service_type_support_t *>(context);
