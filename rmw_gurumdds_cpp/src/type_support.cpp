...
static size_t get_size(void * context)
{
  ...
  if (
    rosidl_typesupport->typesupport_identifier == rosidl_typesupport_introspection_c__identifier)
  {
  ...
  const std::string & metastring)
{
  ...
  raii::dds_TypeSupport dds_type_support{};
...
size_t get_service_request_size(void * context)
{
  ...
  return get_request_enhanced_size(
    rosidl_typesupport->data,
    rosidl_typesupport->typesupport_identifier);
}
...
size_t get_service_request_serialized_size(void * context, void * data)
{
  ...
  if (
    rosidl_typesupport->typesupport_identifier == rosidl_typesupport_introspection_c__identifier)
  {
    auto untyped_member = static_cast<const rosidl_typesupport_introspection_c__ServiceMembers *>(
      rosidl_typesupport->data)
      ->request_members_;
    ...
    rosidl_typesupport_introspection_cpp::typesupport_identifier)
  {
    auto untyped_member = static_cast<const rosidl_typesupport_introspection_cpp::ServiceMembers *>(
      rosidl_typesupport->data)
      ->request_members_;
    return get_serialized_size(untyped_member, rosidl_typesupport->typesupport_identifier, data);
  }
...
size_t
service_request_serialize_direct(void * context, void * data, void * buffer, size_t buffer_size)
{
  bool ret = false;
  auto rosidl_typesupport = reinterpret_cast<rosidl_service_type_support_t *>(context);
  ret = serialize_request_enhanced(
    rosidl_typesupport->data,
    rosidl_typesupport->typesupport_identifier,
  ...
  void * data)
{
  bool ret = false;
  auto rosidl_typesupport = reinterpret_cast<rosidl_service_type_support_t *>(context);
  ret = deserialize_request_enhanced(
    rosidl_typesupport->data,
    rosidl_typesupport->typesupport_identifier,
    static_cast<uint8_t *>(data),
    static_cast<uint8_t *>(buffer),
...
{
  auto rosidl_typesupport = reinterpret_cast<rosidl_service_type_support_t *>(context);
  return get_response_enhanced_size(
    rosidl_typesupport->data,
    rosidl_typesupport->typesupport_identifier);
}
...
size_t
service_response_serialize_direct(void * context, void * data, void * buffer, size_t buffer_size)
{
  bool ret = false;
  auto rosidl_typesupport = reinterpret_cast<rosidl_service_type_support_t *>(context);
  ret = serialize_response_enhanced(
    rosidl_typesupport->data,
    rosidl_typesupport->typesupport_identifier,
    static_cast<uint8_t *>(data),
    static_cast<uint8_t *>(buffer),
  ...
  void * data)
{
  bool ret = false;
  auto rosidl_typesupport = reinterpret_cast<rosidl_service_type_support_t *>(context);
  ret = deserialize_response_enhanced(
    rosidl_typesupport->data,
    rosidl_typesupport->typesupport_identifier,
    static_cast<uint8_t *>(data),
    static_cast<uint8_t *>(buffer),
