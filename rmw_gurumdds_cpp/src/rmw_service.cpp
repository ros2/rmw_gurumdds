  ...
  const char * service_name, const rmw_qos_profile_t * qos_policies)
{
  ...
  const rosidl_service_type_support_t * type_support =
    get_service_typesupport_handle(type_supports, RMW_GURUMDDS_CPP_TYPESUPPORT_C);
  if (type_support == nullptr) {
    type_support = get_service_typesupport_handle(type_supports, RMW_GURUMDDS_CPP_TYPESUPPORT_CPP);
    if (type_support == nullptr) {
