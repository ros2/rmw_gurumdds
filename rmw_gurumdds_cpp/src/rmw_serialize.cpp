  ...
  rmw_serialized_message_t * serialized_message)
{
  const rosidl_message_type_support_t * ts =
    get_message_typesupport_handle(type_support, RMW_GURUMDDS_CPP_TYPESUPPORT_C);
  if (ts == nullptr) {
    ts = get_message_typesupport_handle(type_support, RMW_GURUMDDS_CPP_TYPESUPPORT_CPP);
    if (ts == nullptr) {
