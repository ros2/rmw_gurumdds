...
void ListenerContext::add_information(
...
void ListenerContext::remove_information(
...
void ListenerContext::trigger_graph_guard_condition()
{
  rmw_ret_t ret =
...
size_t ListenerContext::count_topic(const char * topic_name)
{
  std::lock_guard<std::mutex> guard(mutex_);
...
void ListenerContext::fill_topic_names_and_types(
  bool no_demangle,
...
void ListenerContext::fill_service_names_and_types(
...
void ListenerContext::fill_topic_names_and_types_by_guid(
  bool no_demangle,
...
void ListenerContext::fill_service_names_and_types_by_guid(
  std::map<std::string, std::set<std::string>> & services,
  GuidPrefix_t & participant_guid,
