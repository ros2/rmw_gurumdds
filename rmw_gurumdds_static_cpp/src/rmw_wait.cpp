...
{
  return shared__rmw_create_wait_set(gurum_gurumdds_static_identifier, context, max_conditions);
}

rmw_ret_t
rmw_destroy_wait_set(rmw_wait_set_t * wait_set)
{
  return shared__rmw_destroy_wait_set(gurum_gurumdds_static_identifier, wait_set);
}
  ...
  const rmw_time_t * wait_timeout)
{
  return shared__rmw_wait<GurumddsSubscriberInfo, GurumddsServiceInfo, GurumddsClientInfo>(
    gurum_gurumdds_static_identifier, subscriptions, guard_conditions,
